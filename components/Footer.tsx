      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-20">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-brand-gray/60 max-w-sm font-sans font-light">
              Escritório de arquitetura focado na excelência projetual e na identidade única de cada cliente.
            </p>
          </div>

          {/* Links */}
          <div>
            <h3 className="font-mono text-xs font-bold mb-6 text-brand-red uppercase tracking-widest">Menu</h3>
          ...
          {/* Social */}
          <div>
            <h3 className="font-mono text-xs font-bold mb-6 text-brand-red uppercase tracking-widest">Social</h3>
